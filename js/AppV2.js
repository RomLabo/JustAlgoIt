        ...
        this.allModelBtn.forEach(modelBtn => modelBtn.addEventListener("click", () => {
            switch (modelBtn.id) {
                ...
                case "breakdown":
                    ...
                    let txt = [
                        this.clickAreaClicked.txt[0].join(' '),
                        this.clickAreaClicked.txt[1].join('\n'),
                        this.clickAreaClicked.txt[2].join(' ')
                    ];
                    ...
                    this.currentAlgo.createNode(208,[
                        ...
                        (this.clickAreaClicked.height*1.5)|0,
                        this.clickAreaClicked.txt
                    ]);
